...
> **Personal fork** — I use this mainly for downloading YouTube and SoundCloud content on Linux. If you're looking for the original project, head to [aandrew-me/ytDownloader](https://github.com/aandrew-me/ytDownloader).

> **Note to self:** AppImage works best for me on Fedora. Flatpak version sometimes has issues with the output directory picker.

> **Tip:** For SoundCloud playlists, use the "Audio only" option with MP3 at 320kbps — works great every time.

> **Tip:** For YouTube videos, 1080p with mp4 container is the most compatible combo for playing back on my TV via Jellyfin.
...
<a href="https://flathub.org/apps/io.gitdownload/YTDown="https://user8edd12a-ef58-4a05-96a3-99d7490b42f6.png" styleloader/releases/latest/download/64.dmg"><img src="https://cdn.jsdelivr.net/gh/aandrew-me/badges/download_mac_apple_silicon.png" style="width:200px;"></a>
...
✅ Video Compressor with Hardware Acceler